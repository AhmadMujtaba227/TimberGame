...
int main()
{
	...
	//Load the graphics into the texture
	...
	while (window.isOpen())
	{
		...
		//make sure we are accepting inputs
		if (acceptInput)
		{
			//More code here next...

			//First handle pressing the Right curson key
		...
		if (!paused)
		{
				...
				//Move the bee
			{
				...
				{
					//Set it up already to be a whole new bee next frame
					beeActive = false;
				}
			}
			...
			else
			{
				...
				//Has the cloud reached the right side edge of the screen?
			...
			//Has the player been squashed by the branch?
